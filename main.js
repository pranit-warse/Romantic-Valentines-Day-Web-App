document.addEventListener("DOMContentLoaded", function () {
    ...
    let partnerName = "Shreya"; // Replace with dynamic value
    ...
    yesButton.addEventListener("click", function () {
        questionText.innerHTML = `<span class="partner-name">${partnerName}</span><br><span class="love-text">I love you My GulamJamun ❤️</span>`;
